...
$option.Text = "&Options"
$button_click5 = {[System.Windows.Forms.Application]::EnableVisualStyles();
                   $form5 = new-object Windows.Forms.Form
                   $form5.Text = "Opcions window"
                   $form5.Width = 650;
                   $form5.Height =  350;
                   ...
                   $label5.Location = New-Object System.Drawing.Point(250,20)
                   $label5.Size = New-Object System.Drawing.Size(150,40)
                   $label5.Font = New-Object System.Drawing.Font("Times new Roman",20,[System.Drawing.FontStyle]::Regular)
                   $label5.Text = 'Not done'

                   #text part

                   $text5 = New-Object System.Windows.Forms.Label
                   $text5.Location = New-Object System.Drawing.Point(100,100)
                   $text5.Size = New-Object System.Drawing.Size(500,500)
                   $text5.Text = 'Work in progress.I dont have any idea what to put here.'

                   #ok button

                   $okButton5 = New-Object System.Windows.Forms.Button
                   $okButton5.Location = New-Object System.Drawing.Point(500,250)
                   $okButton5.Size = New-Object System.Drawing.Size(75,23)
                   $okButton5.Text = 'Cancel'
                   $okButton5.DialogResult = [System.Windows.Forms.DialogResult]::OK
                   $form5.AcceptButton = $okButton5
                   $form5.Controls.Add($okButton5)

                   $form5.Controls.Add($label5)
                   $form5.Controls.Add($text5)
                   $form5.Add_Shown( { $form5.Activate() } )
                   $form5.ShowDialog()}
$option.Add_Click($Button_Click5)
...
$button_click2 = {Get-Content $picture | Out-Printer; write-host "The picture is printing($picture)"}
...
function OnClick_openToolStripMenuItem($Sender,$e){
    ...
    if ( !$picture ){
        ...
        $Menu2 = new-object System.Windows.Forms.MenuStrip
        #$exit = new-object System.Windows.Forms.ToolStripMenuItem
        #$exit2 = new-object System.Windows.Forms.ToolStripMenuItem
        ...
        $form2.Controls.Add($Menu2)

        #Menu

            $Menu2.Items.AddRange(@(
            $print))
            $Menu2.Location = new-object System.Drawing.Point(0, 0)
            $Menu2.Name = "MS_Main2"
            $Menu2.Size = new-object System.Drawing.Size(300, 20)
            $Menu2.TabIndex = 0
            $Menu2.Text = "menuStrip2"
